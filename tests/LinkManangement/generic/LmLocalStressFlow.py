...
class LmLocalStressFlow(LmStressFlow):
    ...
    def do_stress(self, dut, lp):
        self.log.info("performing local stress")
        self.log.info("performing local stress on dut port {}".format(dut.port_number))
        self.log.info("performing local stress on lp port {}".format(lp.port_number))
